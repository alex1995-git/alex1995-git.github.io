...
import com.depcue.config.JwtTokenUtil;
import com.depcue.model.Abono;
import com.depcue.model.Token;
...
public class RestJwtAuthenticationController {
	...
	@GetMapping(value = "/authenticateValidate")
	public ResponseEntity<String> validateAuthenticationToken() {
